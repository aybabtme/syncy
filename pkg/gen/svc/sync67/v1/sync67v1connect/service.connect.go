...
package sync67v1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/aybabtme/syncy/pkg/gen/svc/sync67/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SyncServiceName = "svc.sync67.v1.SyncService"
)
...
// SyncServiceClient is a client for the svc.sync67.v1.SyncService service.
...
// NewSyncServiceClient constructs a client for the svc.sync67.v1.SyncService service. By default,
...
// CreateAccount calls svc.sync67.v1.SyncService.CreateAccount.
...
// CreateProject calls svc.sync67.v1.SyncService.CreateProject.
...
// Stat calls svc.sync67.v1.SyncService.Stat.
...
// ListDir calls svc.sync67.v1.SyncService.ListDir.
...
// GetSignature calls svc.sync67.v1.SyncService.GetSignature.
...
// GetFileSum calls svc.sync67.v1.SyncService.GetFileSum.
...
// Create calls svc.sync67.v1.SyncService.Create.
...
// Patch calls svc.sync67.v1.SyncService.Patch.
...
// Delete calls svc.sync67.v1.SyncService.Delete.
...
// SyncServiceHandler is an implementation of the svc.sync67.v1.SyncService service.
...
func NewSyncServiceHandler(svc SyncServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/svc.sync67.v1.SyncService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSyncServiceHandler) CreateAccount(context.Context, *connect.Request[v1.CreateAccountRequest]) (*connect.Response[v1.CreateAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.CreateAccount is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) CreateProject(context.Context, *connect.Request[v1.CreateProjectRequest]) (*connect.Response[v1.CreateProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.CreateProject is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) Stat(context.Context, *connect.Request[v1.StatRequest]) (*connect.Response[v1.StatResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.Stat is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) ListDir(context.Context, *connect.Request[v1.ListDirRequest]) (*connect.Response[v1.ListDirResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.ListDir is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) GetSignature(context.Context, *connect.Request[v1.GetSignatureRequest]) (*connect.Response[v1.GetSignatureResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.GetSignature is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) GetFileSum(context.Context, *connect.Request[v1.GetFileSumRequest]) (*connect.Response[v1.GetFileSumResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.GetFileSum is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) Create(context.Context, *connect.ClientStream[v1.CreateRequest]) (*connect.Response[v1.CreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.Create is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) Patch(context.Context, *connect.ClientStream[v1.PatchRequest]) (*connect.Response[v1.PatchResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.Patch is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) Delete(context.Context, *connect.Request[v1.DeleteRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.sync67.v1.SyncService.Delete is not implemented"))
}
