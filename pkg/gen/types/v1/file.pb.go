...
type FileSum struct {
	...
	Info      *FileInfo       `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"`
	SumBlocks []*FileSumBlock `protobuf:"bytes,2,rep,name=sum_blocks,json=sumBlocks,proto3" json:"sum_blocks,omitempty"`
}
...
type FileSumBlock struct {
	...
	StrongSig []byte `protobuf:"bytes,2,opt,name=strong_sig,json=strongSig,proto3" json:"strong_sig,omitempty"` // blake3 sum256 (32 bytes)
...
func (x *FileSumBlock) GetStrongSig() []byte {
	if x != nil {
		return x.StrongSig
	}
	return nil
...
var file_types_v1_file_proto_rawDesc = []byte{
	...
	0x05, 0x69, 0x73, 0x44, 0x69, 0x72, 0x22, 0x68, 0x0a, 0x07, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x75,
	0x6d, 0x12, 0x26, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x12, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x35, 0x0a, 0x0a, 0x73, 0x75, 0x6d,
	0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e,
	...
	,
...
var file_types_v1_file_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_types_v1_file_proto_depIdxs = []int32{
	...
	4, // 1: types.v1.FileInfo.mod_time:type_name -> google.protobuf.Timestamp
...
func file_types_v1_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_types_v1_file_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
