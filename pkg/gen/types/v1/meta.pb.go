...
func (x *ReqMeta) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
func (x *ReqMeta) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
var file_types_v1_meta_proto_rawDesc = []byte{
	...
	0x47, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63,
	...
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x22, 0x09, 0x0a, 0x07, 0x52, 0x65, 0x73, 0x4d,
	0x65, 0x74, 0x61, 0x42, 0x8e, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x79, 0x70, 0x65,
	0x73, 0x2e, 0x76, 0x31, 0x42, 0x09, 0x4d, 0x65, 0x74, 0x61, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
func file_types_v1_meta_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_types_v1_meta_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*ReqMeta); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_types_v1_meta_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ResMeta); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
